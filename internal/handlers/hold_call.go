...
func HoldCallHandler(workerManager *workermanager.WorkerManager) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := client.HoldCall(r.Context(), req)
		if err != nil {
			http.Error(w, "Failed to hold call", http.StatusInternalServerError)
			return
		}
